...
# db.url=jdbc:mysql://mysql-[your-id].e.aivencloud.com:/universitymanagementsystem?useSSL=true&requireSSL=true&verifyServerCertificate=false&serverTimezone=UTC
# db.user=avnadmin
# =
"@
